...
if ( ! function_exists( 'hello_worldsetup' ) ) :
	/**
	...
	function hello_worldsetup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'hello_worldcustom_background_args',
				array(
...
add_action( 'after_setup_theme', 'hello_worldsetup' );
 ...
 */
function hello_worldcontent_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'hello_worldcontent_width', 640 );
}
add_action( 'after_setup_theme', 'hello_worldcontent_width', 0 );
 ...
 */
function hello_worldwidgets_init() {
	register_sidebar(
		array(
...
add_action( 'widgets_init', 'hello_worldwidgets_init' );

/**
 * Enqueue scripts and styles.
 */
function hello_worldscripts() {
...
add_action( 'wp_enqueue_scripts', 'hello_worldscripts' );
